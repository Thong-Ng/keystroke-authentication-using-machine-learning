...
class KeystrokeDynamicsRecorder:
    ...
    def __init__(self, root):
        ...
        self.label_title = tk.Label(root, text="SIGN UP", font=("Verdana", 20))
        ...
        self.checkbox = tk.Checkbutton(root, text="Administrator", font=("Verdana", 10),
                                       variable=self.checkbox_var, command=self.check_target)
        self.checkbox.grid(row=2, column=1, sticky=E)
        ...
        self.c_label = tk.Label(root, text="Counter :", font=("Verdana", 10))
        self.c_label.grid(row=5, column=0, sticky=W, padx=20, pady=10)

        self.counter_label = tk.Label(root, text="0", font=("Verdana", 10))
        self.counter_label.grid(row=5, column=1, sticky=W)
        ...
        self.entry.grid(row=6, column=1, sticky=W)

        self.save_button = tk.Button(root, text="Save", font=("Verdana", 10),
                                     command=self.export_results)
        self.save_button.grid(row=7, column=1, sticky=E, ipadx=20, pady=10)

        self.clear_button = tk.Button(root, text="Clear", font=("Verdana", 10),
                                      command=self.clear_entry)
        self.clear_button.grid(row=7, column=1, ipadx=20)
    ...
    def export_results(self):
        ...
        if self.validate():
            ...
            insert_query = "INSERT INTO keystroke (User_ID, User_Pwd, salt, Target, key_1, key_2, key_3, key_4, " \
            ...
            data_values = (self.entry_name.get(), hashed_password, salt, self.target,
            ...
            self.counter += 1
            self.counter_label.config(text=f"{self.counter}")
